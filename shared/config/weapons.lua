...
Config.Weapons = {
    -- Addon
    {name = "WEAPON_POOLCUELV0", label = "POOLCUE", components = {}  },
    {name = "WEAPON_POOLCUELV1", label = "POOLCUE LV1", components = {}  },
    {name = "WEAPON_POOLCUELV2", label = "POOLCUE LV2", components = {}  },
    {name = "WEAPON_POOLCUELV3", label = "POOLCUE LV3", components = {}  },
    {name = "WEAPON_POOLCUELV4", label = "POOLCUE LV4", components = {}  },

    {name = "WEAPON_BOTTLELV0", label = "BOTTLE", components = {}  },
    {name = "WEAPON_BOTTLELV1", label = "BOTTLE LV1", components = {}  },
    {name = "WEAPON_BOTTLELV2", label = "BOTTLE LV2", components = {}  },
    {name = "WEAPON_BOTTLELV3", label = "BOTTLE LV3", components = {}  },
    {name = "WEAPON_BOTTLELV4", label = "BOTTLE LV4", components = {}  },

    {name = "WEAPON_KNUCKLELV0", label = "KNUCKLE", components = {}  },
    {name = "WEAPON_KNUCKLELV1", label = "KNUCKLE LV1", components = {}  },
    {name = "WEAPON_KNUCKLELV2", label = "KNUCKLE LV2", components = {}  },
    {name = "WEAPON_KNUCKLELV3", label = "KNUCKLE LV3", components = {}  },
    {name = "WEAPON_KNUCKLELV4", label = "KNUCKLE LV4", components = {}  },

    {name = "WEAPON_MACHETTELV0", label = "MACHETTE", components = {}  },
    {name = "WEAPON_MACHETTELV1", label = "MACHETTE LV1", components = {}  },
    {name = "WEAPON_MACHETTELV2", label = "MACHETTE LV2", components = {}  },
    {name = "WEAPON_MACHETTELV3", label = "MACHETTE LV3", components = {}  },
    {name = "WEAPON_MACHETTELV4", label = "MACHETTE LV4", components = {}  },

    {name = "WEAPON_REVOLVERLV0", label = "REVOLVER", components = {}  },
    {name = "WEAPON_REVOLVERLV1", label = "REVOLVER LV1", components = {}  },
    {name = "WEAPON_REVOLVERLV2", label = "REVOLVER LV2", components = {}  },
    {name = "WEAPON_REVOLVERLV3", label = "REVOLVER LV3", components = {}  },
    {name = "WEAPON_REVOLVERLV4", label = "REVOLVER LV4", components = {}  },

    {name = "WEAPON_DAGGERLV0", label = "DAGGER", components = {}  },
    {name = "WEAPON_DAGGERLV1", label = "DAGGER LV1", components = {}  },
    {name = "WEAPON_DAGGERLV2", label = "DAGGER LV2", components = {}  },
    {name = "WEAPON_DAGGERLV3", label = "DAGGER LV3", components = {}  },
    {name = "WEAPON_DAGGERLV4", label = "DAGGER LV4", components = {}  },

    {name = "WEAPON_SWITCHBLADELV0", label = "SWITCHBLADE", components = {}  },
    {name = "WEAPON_SWITCHBLADELV1", label = "SWITCHBLADE LV1", components = {}  },
    {name = "WEAPON_SWITCHBLADELV2", label = "SWITCHBLADE LV2", components = {}  },
    {name = "WEAPON_SWITCHBLADELV3", label = "SWITCHBLADE LV3", components = {}  },
    {name = "WEAPON_SWITCHBLADELV4", label = "SWITCHBLADE LV4", components = {}  },
