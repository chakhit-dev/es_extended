...
-- function ESX.createESXPlayer(identifier, playerId, data)
--     local accounts = {}
...
function loadESXPlayer(identifier, playerId, isNew)
    ...
    local xPlayer = CreateExtendedPlayer(playerId, identifier, userData.ssn, userData.group, userData.accounts, userData.inventory, userData.limit, userData.job, userData.loadout, GetPlayerName(playerId), userData.coords, userData.metadata)
